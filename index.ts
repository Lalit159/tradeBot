...
async function main() {
    ...
    await new Promise((resolve) => setTimeout(resolve, 10000)); // creating delay for 10s (SLEEP function)
    await cancelAll("XAIINR");
    await new Promise((resolve) => setTimeout(resolve, 1000)); // creating delay for 1s
    main();
}
